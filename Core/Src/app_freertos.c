...
#include "../Threads/process_task.h"
...
const osThreadAttr_t ProcessLogTask_attributes = {
  .name = "ProcessLogTask",
...
void MX_FREERTOS_Init(void) {
  ...
  /* add threads, ... */
  ProcessLogTaskHandle = osThreadNew(ProcessLogTask, NULL, &ProcessLogTask_attributes);
